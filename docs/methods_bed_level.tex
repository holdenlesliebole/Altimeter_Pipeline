...
\paragraph{Sequential anchoring.} For SIO~pier (no surveys available),
consecutive deployments were chained by matching the last valid burst
of deployment $N$ to the first valid burst of deployment $N{+}1$.
This is valid because instrument swaps occurred on the same dive day,
with the pipe mount point unchanged. Sequential offsets were typically
